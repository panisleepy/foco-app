...
export function WelcomeScreen({ onSocialContinue, onEmailContinue }: WelcomeScreenProps) {
  return (
    <motion.div
    ...
    >
      ...
      <GlassCard className="w-full max-w-md px-7 py-9">
        <h1 className="mb-2 font-serif text-2xl font-semibold tracking-tight text-zinc-900 dark:text-white">
          Welcome back
        </h1>
